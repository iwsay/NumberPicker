...
class NumberPicker extends StatelessWidget {
  ...
  static const double DEFAULT_ITEM_EXTENT = 75.0;
  ...
  Widget _integerListView(ThemeData themeData) {
    TextStyle defaultStyle =
        themeData.textTheme.subhead.copyWith(color: Color(0xff959cb0));
    TextStyle selectedStyle =
        themeData.textTheme.headline.copyWith(color: Color(0xff194163));
                        ...
                        ? Container(
                            decoration: isBorder
                                ? BoxDecoration(
                                    ...
                                    border:
                                        Border.all(color: Color(0xff19b1d8)),
